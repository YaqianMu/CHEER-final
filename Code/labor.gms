...
Parameter 	labor_v0(*,*)  	sectoral labor costs value by labor type in billion  yuan
			labor_q0(*,*)  	sectoral labor quantity by labor type
			labor_w0(*,*)  	sectoral labor wage value by labor type in billion yuan per thousand person
			labordata(*,*);
...
*=== transfer unit from 10 Thousand people to thousand people
			...
			labor_w0(lm,i)$labor_q0(lm,i) 			
								=	labor_v0(lm,i)/labor_q0(lm,i);
			labor_w0(lm,i)$(labor_q0(lm,i) eq 0) 	
								= 	0.001;
...
parameter 	bwage(*)    the average wage of labor by type from micro data in yuan per people
			bur(*)     	the benchmark unemployment rate ;
...
parameter 	fwage_s(lm,i)  	factor of average wage among sectors
			awage_e(lm)  	average wage among education in billion yuan per thousand person;
