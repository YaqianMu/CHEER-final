...
parameter
         	...
         	taxist0			Tax cost in ist generation
         	outputist0     	Output of ist generation
         	Toutputist0     Total output of ist generation;
			...
			taxist0(sub_ist)$outputist0(sub_ist)
								=		taxist0(sub_ist)/outputist0(sub_ist);
...
parameter 	laborist0 	labor input by category;
