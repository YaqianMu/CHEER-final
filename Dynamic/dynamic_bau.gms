...
*==code for learning curve
	...
	mkup_t(t,sub_elec)$(ord(t) eq 1) 	
								=	((elecout_t(t,sub_elec))/elecout_t("2012",sub_elec))**bata(sub_elec)*mkup_t("2012",sub_elec) ;

	mkup_t(t,sub_elec)$(ord(t) gt 1) 
								= 	((elecout_t(t-1,sub_elec))/elecout_t("2012",sub_elec))**bata(sub_elec)*mkup_t("2012",sub_elec) ;
...
*report2("total")=report2("fossil")+report2("cement");
	...
	report8("share",t,sub_elec)$(not wse(sub_elec))
									=	qelec.l(sub_elec)/report8("output",t,"Total");
	report8("share",t,sub_elec)$(wse(sub_elec))
									=	qelec.l(sub_elec)/report8("output",t,"Total");

	report12("Billion Yuan",t,e)	=	qc.l(e)+sum(j,qin.l(e,j))+sum(sub_elec,qin_ele.l(e,sub_elec));
	report12("Billion Yuan",t,sub_elec)
									=	report12("Billion Yuan",t,"elec")*report8("share",t,sub_elec);
*report12("coal equivalent calculation(Mt)",t,fe)=eet(fe)/100*report12("Billion Yuan",t,fe)/report12("Billion Yuan","2012",fe);
*report12("coal equivalent calculation(Mt)",t,sub_elec)$(cfe(sub_elec))=eet(sub_elec)/100*report12("Billion Yuan",t,sub_elec)/report12("Billion Yuan","2012",sub_elec);
